...
st.image("/app/yolov4/app/example.jpg",width=240,use_column_width='auto')
...
if uploaded_file is not None:
    ...
    print(data)
    st.image("/app/darknet/predictions.jpg")
    f = open('/app/darknet/out.txt', 'r')
